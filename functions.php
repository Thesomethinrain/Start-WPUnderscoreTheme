...
function underscore_scripts() {
	...
	wp_enqueue_script( 'underscore-navigation', get_template_directory_uri() . '/dist/js/lib/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'underscore-skip-link-focus-fix', get_template_directory_uri() . '/dist/js/lib/skip-link-focus-fix.js', array(), '20151215', true );
...
function add_js_scripts() {
	//wp_register_script( 'masonry-custom', get_stylesheet_directory_uri().'/dist/js/lib/masonry-custom.js', array('jquery','jquery-masonry'), '1.0', true );
	//wp_register_script( 'infinite-scroll', get_stylesheet_directory_uri().'/js/infinite-scroll.pkgd.min.js', 'jquery', '2.0', true );
...
function add_css_styles() {
    wp_register_style( 'style-theme',get_stylesheet_directory_uri(). '/dist/css/style-theme.css' );
